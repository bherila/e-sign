 ...
 *
 * `omitted_anchor_fields` is the third: normally empty, and when it is not it says that a field the
 * source declared was deliberately not placed, because its anchor declared that its text may
 * legitimately be absent and it was.
 *
...
class EnvelopeResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            // Empty for almost every envelope. Each entry names a field that was declared and
            // intentionally left out because its optional anchor was not in the document — the one
            // narrow compatibility option in docs/HANDOFF.md section 7 (docs/preparation/anchors.md).
