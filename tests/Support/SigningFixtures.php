...
final class SigningFixtures
{
    ...
    {
        // An anchor written by a test may use members that arrived in 1.1, and a document may only
        // use what the version it declares declares. Saying so here keeps every caller from having
        // to remember it.
