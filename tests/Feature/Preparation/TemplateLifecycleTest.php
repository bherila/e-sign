 ...
 * those anchors, so a document without that text would make every publish in this file a
 * failure case (docs/preparation/anchors.md).
 */
class TemplateLifecycleTest extends TestCase
{
    ...
    public function test_the_snapshot_carries_everything_an_envelope_copies(): void
    {
        ...
        // The field set is the canonical document with its anchors resolved, and the digest is the
        // digest of exactly that. Publishing is where an anchor becomes a rectangle, so the snapshot
        // an envelope copies is already placed (docs/preparation/anchors.md).
        ...
        // Everything that is not anchored is exactly what was submitted.
